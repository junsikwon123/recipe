        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">재고 관리</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block"
                                                                role="button" href="javascript:window.print()"><i
                        class="fas fa-download fa-sm text-white-50"></i> 보고서 출력</a>
                </div>
<%--                재고 관리 페이징 Start --%>
                <div class="invenManagement" style="height: 80%">
                    <table class="table">
                        <thead>
                        <tr>
                            ...
                            <th scope="col"><h4>단위</h4></th>
                            <th scope="col"><h4>수량</h4></th>
                            <th scope="col"><h4>단가</h4></th>
                            <th scope="col"><h4>합계</h4></th>
                            <th scope="col"><h4>상품 등록일</h4></th>
                            <th scope="col"><h4>유통기한</h4></th>
                        </tr>
                        </thead>
                        <tbody>
<%--                        <c:forEach var="i" items="k">--%>
                            <tr>
                                <th scope="row">1</th>
                                <a href="/Main"><td>0X25BDEGFUCK</td></a>
                                <a href="#"><td>고등어</td></a>
                                <a href="#"><td>물고기</td></a>
                                <a href="#"><td>183</td></a>
                                <a href="#"><td>100￦</td></a>
                                <a href="#"><td>18,300￦</td></a>
                                <a href="#"><td>2024/07/02</td></a>
                                <a href="#"><td>2024/07/03</td></a>
                            </tr>
<%--                        </c:forEach>--%>
                        </tbody>
                    </table>
