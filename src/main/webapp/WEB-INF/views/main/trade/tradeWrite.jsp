        ...
        <div id="liMaterialGroup_1">
            ...
            <ul id="divMaterialArea_1" class="ui-sortable">
                <li id="liMaterial_1_1">
                   <input type="text" name="t_item" id="trade_no1_1" class="form-control"  placeholder="예) 돼지고기">
            ...
            <div class="btn_add" style="padding:0 0 20px 350px; width: 800px;">
                <button id="addBtn" type="button" class="btn btn-default">
                    <sapn class="glyphicon glyphicon-plus-sign"></sapn>재료추가
                </button>
            </div>
        </div>
    </div>
...
<div class="regi_btm">
    <button id="saveBtn" class="btn-lg btn-primary">저장</button>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      document.getElementById("addBtn").addEventListener("click",function (){
          ...
          newLi.className="liMaterial_1_"+inputCount
          newBtn.type="button"
