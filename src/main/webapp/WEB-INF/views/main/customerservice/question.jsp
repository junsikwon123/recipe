    ...
    <div style="display: flex; flex-direction: column">
            ...
            <div style="width: 950px; margin-left: 100px; margin-top: 25px">
                <table class="table table-group-divider table-borderless">
                    ...
                    <tr>
                        ...
                        <td colspan="4"><input type="text" style="height: 40px; width: 500px" disabled></td>
                        <td>
                            <button style="height: 40px; width: 150px; border: lightgray 1px solid">조회</button>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
        ...
        <div style="display: flex; flex-direction: row-reverse">
            <div style="width: 90%; text-align: center">
                <br>
                <p> ※1:1 문의하기 내역은 마이페이지>1:1문의내역에서 확인할 수 있습니다.</p>
                <br>
