...
// 소분류 안에 값 찍어내는 공장
        ...
        function savePageSize(pageSize) {
            ...
            $.ajax({
                ...
                console.log("페크기변환 DONE")
                sortClassSwitch(null, null, resp)
            }).fail((err) => {
        ...
        function sortClassSwitch(id, ID, resp) {
            if (id !== null) {
                ...
                const classValue = ID === 'Asort selected' ? 'Asort selected' : 'Asort';
                switch (id) {
                    case "fcode":
            ...
            document.getElementById('totalCnt').textContent = listCnt;
            str += "</table><br><br>"
            boardList.html(str)
        }
...
// 카테고리 관리 스트링빌더 같은 느낌
        function cgSort(cgName) {
            ...
            if (cgName.innerHTML === '레시피') {
                ...
                urlSort = "/boardlist?tab=recipe&pageNum=1&pageSize=10";
