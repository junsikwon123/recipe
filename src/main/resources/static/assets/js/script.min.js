...
// 소분류 안에 값 찍어내는 공장
        ...
        function sortClassSwitch2(id, resp) {
            ...
            if (id.substring(0, 1) === '재' || id.substring(0, 1) === 'f') {
                ...
                str += "<th>#</th>"
                str += "<th><h4 style='text-align: center'>등록일<a onclick='boardListSortButton(this.id)' id='fdate'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                str += "<th><h4 style='text-align: center;'>유통기한<a onclick='boardListSortButton(this.id)' id='fedate'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>카테고리<a onclick='boardListSortButton(this.id)' id='fcname'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품코드<a onclick='boardListSortButton(this.id)' id='fcode'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품이름<a onclick='boardListSortButton(this.id)' id='ftitle'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='fcount'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>평균금액<a onclick='boardListSortButton(this.id)' id='favgPrice'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>총 계<a onclick='boardListSortButton(this.id)' id='fcountSum'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                ...
                str += "<tr class='table-primary' id='mInven' style='vertical-align: center'>"
                str += "<td>" + i + "</td>"
                str += "<th><h4>유통기한<a onclick='boardListSortButton(this.id)' id='edate'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>카테고리<a onclick='boardListSortButton(this.id)' id='ecname'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품이름<a onclick='boardListSortButton(this.id)' id='etitle'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='ecount'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<td><input id='allClickCk' onclick='allClickCk(this)' value='selectAll' type='checkbox'>전체&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' onclick='moveToDeleteBox(this)' class='btn btn-danger'>폐기</button></td>"
                str += "</tr>"
                for (const elem of resp) {
                    str += "<tr class='fooditem' data-num='" + elem.f_code + "'>"
                ...
                str += "<tr class='table-primary' id='mInven' style='vertical-align: center'>"
                str += "<td>#</td>"
                str += "<th><h4>거래처<a onclick='boardListSortButton(this.id)' id='pcompany'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품명<a onclick='boardListSortButton(this.id)' id='pcname'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>가격<a onclick='boardListSortButton(this.id)' id='pprice'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>부가세<a onclick='boardListSortButton(this.id)' id='pvat'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='pcount'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>단가<a onclick='boardListSortButton(this.id)' id='ppriceSum'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>합계<a onclick='boardListSortButton(this.id)' id='ptotal'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>현황<a onclick='boardListSortButton(this.id)' id='pcurrent'></h4></th>"
        ...
        function sortClassSwitch(id, resp) {
            ...
            if (id !== null) {
                if (id.substring(0, 1) === '식' || id.substring(0, 1) === 'f') {
                    ...
                    str += "<th><h4>상품코드<a onclick='boardListSortButton(this.id)' id='fcode'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th><h4>대분류<a onclick='boardListSortButton(this.id)' id='fcnum'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>중분류<a onclick='boardListSortButton(this.id)' id='fcnum2'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>상품이름<a onclick='boardListSortButton(this.id)' id='ftitle'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>가격<a onclick='boardListSortButton(this.id)' id='fprice'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='fcount'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>등록일<a onclick='boardListSortButton(this.id)' id='fdate'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>유통기한<a onclick='boardListSortButton(this.id)' id='fedate'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<td><input id='allClickCk' onclick='allClickCk(this)' value='selectAll' type='checkbox'>전체&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' onclick='ckBoxDeleteBtn(this)' class='btn btn-danger'>삭제</button></td>"
                    str += "</tr>"
                    ...
                    str += "<table class='table my-0 table-hover' id='dataList'>"
                    str += "<tr class='table-primary' id='mPage' style='vertical-align: center'><th>#</th>"
                    str += "<th><h4>작성자<a onclick='boardListSortButton(this.id)' id='rName'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th style='width: 60%'><h4 style='text-align: center'>제목<a onclick='boardListSortButton(this.id)' id='rTitle'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th><h4>작성일<a onclick='boardListSortButton(this.id)' id='rDate'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th><h4>조회수<a onclick='boardListSortButton(this.id)' id='rViews'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
