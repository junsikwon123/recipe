...
// 소분류 안에 값 찍어내는 공장
        ...
        function openDetailModal(e) {
            ...
            $.ajax({
                ...
                if (trClass === 'fooditem') {
                    ...
                    str += "<pre>칼로리 : " + resp[0].f_cal + "cal</pre>"
        ...
        function modalDetailsUpdate() {
            ...
            //
            let updateFcode = document.getElementById('dmiu_f_code')
            let updateCnum = document.getElementById('dmiu_c_num')
            let updateCnum2 = document.getElementById('dmiu_c_num2')
            let updateFprice = document.getElementById('dmiu_f_price')
            let updateFcount = document.getElementById('dmiu_f_count')
            let updateForigin = document.getElementById('dmiu_f_origin')
            let updateFsave = document.getElementById('dmiu_f_save')
            let updateFcal = document.getElementById('dmiu_f_cal')
            let updateData = [];
        ...
        function moveToDeleteBox(e) {
            ...
            isChecked.forEach((item) => {
                ...
                let bigCgNum = selectTr.getAttribute('data-cnum')
                let code = selectTr.getAttribute('data-code')
                let cgName = selectTr.getAttribute('data-cname')
                let title = selectTr.getAttribute('data-title')
                deleteKeySet.push(bigCgNum)
                deleteKeySet.push(code)
                deleteKeySet.push(cgName)
                deleteKeySet.push(title)
            })
