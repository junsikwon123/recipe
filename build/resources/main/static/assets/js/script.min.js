...
// 소분류 안에 값 찍어내는 공장
        ...
        function savePageSize(pageSize) {
            ...
            switch (boardTitle.innerHTML.trim()) {
                ...
                case "재고 관리":
                    ...
                    thisData = {
                        "pageNum": pageNum,
                        "pageSize": pageSize,
                        "currentMenu": boardTitle.innerHTML.substring(0, 1)
                    }
                    break;
                default:
            ...
            $.ajax({
                ...
                switch (currentID.substring(0, 1)) {
                    case "식":
                        sortClassSwitch(currentID, null, resp)
                        break;
                    case "레":
                        sortClassSwitch(currentID, null, resp)
                        break;
                    case "재":
                        sortClassSwitch2(currentID, null, resp)
                        break;
                    default:
        ...
        function openDetailModal(e) {
            ...
            $.ajax({
                method: 'get',
                url: "/boardlist/modaldetails",
                data: {"trClass": trClass, "trCode": trCode}
            }).done((resp) => {
                console.log("[상세] DONE")
                if (trClass === 'fooditem') {
        ...
        let f_title = "Asort"
        let f_count = "Asort"
        let f_avgPrice = "Asort"
        let f_countSum = "Asort"

        // 클래스 스위칭 및 각종 함수에서 테이블 생성 - [재고관리]
        function sortClassSwitch2(id, className, resp) {
            console.log("[재고] 테이블 생성기 ON")
            ...
            let i = 1;
            if (!resp) {
                console.log("[재고] resp null")
            }
            contents.html('')
            if (className !== null) {
                console.log("[재고] 스위치펑션 실행")
                const classValue = className === 'Asort' ? 'Asort selected' : 'Asort';
                switch (id) {
                    case "fdate":
                        f_date = classValue;
                        break;
                    ...
                    case "fcount":
                        ...
                        break;
                    case "favgPrice":
                        f_avgPrice = classValue;
                        break;
                    case "fcountSum":
                        f_countSum = classValue;
                        break;
                    case "edate":
                        f_edate = classValue;
                        break;
                    ...
                    case "ecount":
                        ...
                        break;
                    default:
                        console.log("스위치펑션2 에러: 알 수 없는 id : " + id);
                }
            }
            // 재고량 확인
            if (id.substring(0, 1) === '재' || id.substring(0, 1) === 'f') {
                ...
                str += "<table class='table my-0 table-hover' id='dataList'>"
                str += "<tr class='table-primary' id='mInven' style='vertical-align: center'>"
                str += "<th>#</th>"
                str += "<th><h4 style='text-align: center'>등록일<a onclick='boardListSortButton(this.id)' id='fdate' class='" + f_date + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                str += "<th><h4 style='text-align: center;'>유통기한<a onclick='boardListSortButton(this.id)' id='fedate' class='" + f_edate + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>카테고리<a onclick='boardListSortButton(this.id)' id='fcname' class='" + f_cname + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품코드<a onclick='boardListSortButton(this.id)' id='fcode' class='" + f_code + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품이름<a onclick='boardListSortButton(this.id)' id='ftitle' class='" + f_title + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='fcount' class='" + f_count + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>평균금액<a onclick='boardListSortButton(this.id)' id='favgPrice' class='" + f_avgPrice + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>총 계<a onclick='boardListSortButton(this.id)' id='fcountSum' class='" + f_countSum + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                ...
                str += "<tr class='table-primary' id='mInven' style='vertical-align: center'>"
                str += "<td>" + i + "</td>"
                str += "<th><h4>유통기한<a onclick='boardListSortButton(this.id)' id='edate' class='" + f_edate + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>카테고리<a onclick='boardListSortButton(this.id)' id='ecname' class='" + f_cname + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품이름<a onclick='boardListSortButton(this.id)' id='etitle' class='" + f_title + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='ecount' class='" + f_count + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<td><input id='allClickCk' onclick='allClickCk(this)' value='selectAll' type='checkbox'>전체&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' onclick='moveToDeleteBox(this)' class='btn btn-danger'>폐기</button></td>"
                str += "</tr>"
                for (const elem of resp) {
                    str += "<tr class='fooditem' data-num='" + elem.f_code + "'>"
                ...
                str += "<tr class='table-primary' id='mInven' style='vertical-align: center'>"
                str += "<td>#</td>"
                str += "<th><h4>거래처<a onclick='boardListSortButton(this.id)' id='pdate' class='" + f_edate + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>상품명<a onclick='boardListSortButton(this.id)' id='pcname' class='" + f_cname + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>가격<a onclick='boardListSortButton(this.id)' id='pcount' class='" + f_count + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>부가세<a onclick='boardListSortButton(this.id)' id='pcount' class='" + f_count + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='ptitle' class='" + f_title + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>단가<a onclick='boardListSortButton(this.id)' id='pprice' class='" + f_title + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>합계<a onclick='boardListSortButton(this.id)' id='psum' class='" + f_count + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<th><h4>현황<a onclick='boardListSortButton(this.id)' id='pcurrent' class='" + f_count + "'></h4></th>"
                ...
                for (const elem of resp) {
                    ...
                    if (elem.iv_current === '발주 전') {
                        ...
                        str3 += `<pre> 가격 : ${elem.iv_priceSum} \u20A9 </pre>-<br><br>`;
                        totalSum += removeAndReplace(elem.iv_priceSum)
                        j++
                    }
                    i++
                }
                if (totalSum != null) {
                    let money = "";
                    if (totalSum > 1000) {
                        totalSum = Math.floor(totalSum / 1000);
                        money = "만"
                        if (totalSum > 1000) {
                            totalSum = Math.floor(totalSum / 1000);
                            money = "억"
                    ...
                    str3 += `<h4><pre>                      합계 : ${totalSum} ${money}</pre></h4>`;
                ...
                str += "<tr class='table-primary' id='mInven' style='vertical-align: center'>"
                str += "<td>" + i + "</td>"
                str += "<th style='width: 85%'><h4 style='text-align: center'>폐기내역<a onclick='boardListSortButton(this.id)' id='edate' class='" + f_edate + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                str += "<td><input id='allClickCk' onclick='allClickCk(this)' value='selectAll' type='checkbox'>전체&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' onclick='ckBoxDeleteBtn(this)' class='btn btn-danger'>영구삭제</button></td>"
                str += "</tr>"
            }
            str += "</table><br><br>"
            contents.html(str)
...
// 클래스명을 바꾸기 위한 사전 전역변수 작업
        let fcode_class = "Asort";
        let fcnum_class = "Asort";
        let fcnum2_class = "Asort";
        let ftitle_class = "Asort";
        let fprice_class = "Asort";
        let fcount_class = "Asort";
        let fdate_class = "Asort";
        let fedate_class = "Asort";
        let rName_class = "Asort";
        let rTitle_class = "Asort";
        let rDate_class = "Asort";
        let rViews_class = "Asort";

        // 클래스 스위칭 및 각종 함수에서 테이블 생성 - [홈페이지 관리]
        function sortClassSwitch(id, ID, resp) {
            ...
            let str = "";
            if (ID !== null) {
                console.log("[스위치] id : " + id + " ID : " + ID);
                const classValue = ID === 'Asort' ? 'Asort selected' : 'Asort';
                switch (id) {
                    case "fcode":
                        fcode_class = classValue;
                        break;
                    case "fcnum":
                        fcnum_class = classValue;
                        break;
                    case "fcnum2":
                        fcnum2_class = classValue;
                        break;
                    case "ftitle":
                        ftitle_class = classValue;
                        break;
                    case "fprice":
                        fprice_class = classValue;
                        break;
                    case "fcount":
                        fcount_class = classValue;
                        break;
                    case "fdate":
                        fdate_class = classValue;
                        break;
                    case "fedate":
                        fedate_class = classValue;
                        break;
                    case "rName":
                        rName_class = classValue;
                        break;
                    case "rTitle":
                        fTitle_class = classValue;
                        break;
                    case "rDate":
                        rDate_class = classValue;
                        break;
                    case "rViews":
                        fViews_class = classValue;
                        break;
                    default:
                        console.log("스위치펑션 에러: 알 수 없는 id");
                }
            }
            let i = 1;
            let listCnt = 1;
            if (id !== null) {
                if (id.substring(0, 1) === '식' || id.substring(0, 1) === 'f') {
                    str += "<div class='table-responsive table mt-2' id='dataTable' role='grid' aria-describedby='dataTable_info'>"
                    str += "<table class='table my-0 table-hover' id='dataList'>"
                    str += "<tr class='table-primary' id='mPage' style='vertical-align: center'><th>#</th>"
                    str += "<th><h4>상품코드<a onclick='boardListSortButton(this.id)' id='fcode' class='" + fcode_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th><h4>대분류<a onclick='boardListSortButton(this.id)' id='fcnum' class='" + fcnum_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>중분류<a onclick='boardListSortButton(this.id)' id='fcnum2' class='" + fcnum2_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>상품이름<a onclick='boardListSortButton(this.id)' id='ftitle' class='" + ftitle_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>가격<a onclick='boardListSortButton(this.id)' id='fprice' class='" + fprice_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>수량<a onclick='boardListSortButton(this.id)' id='fcount' class='" + fcount_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>등록일<a onclick='boardListSortButton(this.id)' id='fdate' class='" + fdate_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<th><h4>유통기한<a onclick='boardListSortButton(this.id)' id='fedate' class='" + fedate_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>"
                    str += "<td><input id='allClickCk' onclick='allClickCk(this)' value='selectAll' type='checkbox'>전체&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' onclick='ckBoxDeleteBtn(this)' class='btn btn-danger'>삭제</button></td>"
                    str += "</tr>"
                    ...
                    str += "<table class='table my-0 table-hover' id='dataList'>"
                    str += "<tr class='table-primary' id='mPage' style='vertical-align: center'><th>#</th>"
                    str += "<th><h4>작성자<a onclick='boardListSortButton(this.id)' id='rName' class='" + rName_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th style='width: 60%'><h4 style='text-align: center'>제목<a onclick='boardListSortButton(this.id)' id='rTitle' class='" + rTitle_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th><h4>작성일<a onclick='boardListSortButton(this.id)' id='rDate' class='" + rDate_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
                    str += "<th><h4>조회수<a onclick='boardListSortButton(this.id)' id='rViews' class='" + rViews_class + "'><img src='/assets/img/a/sort.png' style='width: 20px; height: 20px'></a></h4></th>";
...
// 게시글 정렬 버튼
        function boardListSortButton(id) {
            ...
            $.ajax({
                ...
                if (ID.className !== 'Asort selected' && ID.className !== 'Asort') {
                    console.log("항목정렬에서 무언가 잘못되었습니다")
                    return
                }
                console.log("보드리스트 솔트 버튼");
                console.log("1 : " + id)
                console.log("2 : " + ID.className)
                console.log("3 : " + resp)
                switch (ID.closest('tr').id) {
                    case "mPage":
                        sortClassSwitch(id, ID.className, resp)
                        break;
                    case "mInven":
                        sortClassSwitch2(id, ID.className, resp)
                        break;
                }
            }).fail((err) => {
                console.log("[정렬] 에러발생")
        ...
        function createModalInput(cgName) {
        ...
        function cgSort(cgName) {
            ...
            $.ajax({
                ...
                if (cgName.innerHTML === '식자재') {
                    sortClassSwitch(cgName.innerHTML, null, resp)
...
// 자바스크립트 폼데이터 객체 관련
        {
            function modalInputForm() {
                ...
                if (title === '게시판 관리') {
                    ...
                    thisData = {"pageNum":pageNum, "pageSize":pageSize, "company":company, "price":price, "name":name, "count":count};
                } else {
                ...
                $.ajax({
                    ...
                    switch (title) {
                        case "게시판 관리":
                            sortClassSwitch(curCgName, null, resp)
                            break;
                        case "재고 관리":
                            sortClassSwitch2(boardTitle, null, resp)
                    }
                }).fail((err) => {
        ...
        function IVselect(t) {
            ...
            $.ajax({
                ...
                console.log(resp)
                sortClassSwitch2(t.innerHTML, className, resp)
            }).fail((err) => {
